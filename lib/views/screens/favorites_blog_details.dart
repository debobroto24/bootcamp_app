...
class FabBlogDetailsScreen extends ConsumerStatefulWidget {
  const FabBlogDetailsScreen({Key? key, required blogModel}) : super(key: key);

  @override
  _FabBlogDetailsScreenState createState() => _FabBlogDetailsScreenState();
}

class _FabBlogDetailsScreenState extends ConsumerState<FabBlogDetailsScreen> {
